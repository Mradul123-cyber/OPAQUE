...
class TaskFriendsFeedScreen extends StatefulWidget {
  const TaskFriendsFeedScreen({super.key});

  @override
  State<TaskFriendsFeedScreen> createState() => _TaskFriendsFeedScreenState();
}

class _TaskFriendsFeedScreenState extends State<TaskFriendsFeedScreen> {
  ...
  Future<void> _loadFeed({bool refresh = false}) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('https://zarqmessenger.com/tasks/feed/friends?limit=$_limit&offset=$_offset'),
      ...
      print('[TaskFriendsFeedScreen] Error loading feed: $e');
      setState(() => _isLoading = false);
    }
  }
  ...
  Future<void> _reactToSubmission(String submissionId, String reactionType) async {
    try {
      ...
      print('[TaskFriendsFeedScreen] Error reacting: $e');
    }
  }
  ...
  Future<void> _removeReaction(String submissionId) async {
    try {
      ...
      print('[TaskFriendsFeedScreen] Error removing reaction: $e');
    }
  }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'No friends submissions yet',
              style: TextStyle(color: Colors.grey[700], fontSize: 18),
            ),
            const SizedBox(height: 8),
            Text(
              'Your friends haven\'t completed any tasks yet',
  ...
  Widget _buildSubmissionCard(Map<String, dynamic> submission) {
    ...
    final username = submission['username'] ?? 'friend';
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Icon(Icons.verified_user, color: Colors.blue, size: (screenWidth * 0.035).clamp(12.0, 14.0)),
                          const SizedBox(width: 4),
                          Text(
                            'Friend',
                            style: TextStyle(
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.lock, color: Colors.blue, size: (screenWidth * 0.03).clamp(10.0, 12.0)),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    // Share button
                    InkWell(
                      onTap: () => _shareSubmission(submission),
                      borderRadius: BorderRadius.circular(8),
                      child: Padding(
  ...
  Future<List<Map<String, dynamic>>> _loadComments(String submissionId) async {
    try {
      ...
      print('[TaskFriendsFeedScreen] Error loading comments: $e');
    }
    return [];
  }
  ...
  Future<Map<String, dynamic>?> _postComment(
    ...
    try {
      ...
      print('[TaskFriendsFeedScreen] Error posting comment: $e');
    }
    return null;
  }
  ...
  Future<bool> _deleteComment(String commentId) async {
    try {
      ...
      print('[TaskFriendsFeedScreen] Error deleting comment: $e');
      return false;
    }
  }
...
Download Zarq Messenger to participate! 🚀
    ...
    if (mediaUrl != null && mediaUrl.isNotEmpty) {
      try {
        ...
        print('[TaskFriendsFeedScreen] Error sharing image: $e');
        // Fall through to text-only share
      }
    }

    // Fallback to text-only share
    Share.share(shareText, subject: 'Check out this task completion on Zarq!');
  }
